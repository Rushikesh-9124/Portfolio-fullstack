 ...
 * Uses max-w to ensure blocks don't get awkwardly wide on desktop
 */
function SkeletonBlock({ className }) {
  return <div className={`skeleton rounded-xl animate-pulse bg-white/5 ${className}`} />;
}
        ...
        <main className="min-h-screen w-full overflow-x-hidden overflow-y-auto">
          ...
          {loading ? (
            /* Responsive Skeleton Container 
               Adjusts padding and max-widths based on breakpoints 
            */
            ...
            // Ensure section wrappers maintain consistent responsive padding if needed
